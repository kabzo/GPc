...
/*   } */
    ...
    CMatrix(const CMatrix &A, vector<unsigned int> indices) : nrows(indices.size()),
                                                              ncols(1),
                                                              symmetric(false),
                                                              triangular(false) {
        _init();
    ...
    void getMatrix(CMatrix &matrixOut,
    ...
    void trans() {
        ...
        if (nrows != 1 && ncols != 1) {
            dtransr((nrows + ncols) / 2);
        } // this is algorithm 513 (467 doesn't seem to work)
    ...
    void gemvRowRow(unsigned int i,
                    const CMatrix &A,
                    const CMatrix &x,
                    unsigned int k,
                    double alpha,
    ...
    void gemvRowCol(unsigned int i,
                    const CMatrix &A,
                    const CMatrix &x,
                    unsigned int j,
                    double alpha,
    ...
    void gemvColCol(unsigned int j,
                    const CMatrix &A,
                    const CMatrix &x,
                    unsigned int k,
                    double alpha,
    ...
    void gemvColRow(unsigned int j,
                    const CMatrix &A,
                    const CMatrix &x,
                    unsigned int i,
                    double alpha,
    ...
    void symvRowRow(unsigned int i,
                    const CMatrix &A,
                    const CMatrix &x,
                    unsigned int k,
                    double alpha,
                    double beta,
                    const char *upperOrLower);
    // y(i, :)' := alpha A*x(:, j) + beta*y(i, :)';
    void symvRowCol(unsigned int i,
                    const CMatrix &A,
                    const CMatrix &x,
                    unsigned int j,
                    double alpha,
    ...
    void symvColCol(unsigned int j,
                    const CMatrix &A,
                    const CMatrix &x,
                    unsigned int k,
                    double alpha,
    ...
    void symvColRow(unsigned int j,
                    const CMatrix &A,
                    const CMatrix &x,
                    unsigned int i,
                    double alpha,
    ...
    void symvColColOff(unsigned int j,
                       int yr1,
                       const CMatrix &A,
                       const CMatrix &x,
                       unsigned int k,
