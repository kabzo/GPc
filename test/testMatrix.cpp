...
int testDot()
{
  int fail = 0;
  CMatrix A;
  A.readMatlabFile("../matfiles" + ndlstrutil::dirSep() + "dotMatrixTest.mat", "A");
  CMatrix B; 
  B.readMatlabFile("../matfiles" + ndlstrutil::dirSep() + "dotMatrixTest.mat", "B");
  CMatrix C;
  C.readMatlabFile("../matfiles" + ndlstrutil::dirSep() + "dotMatrixTest.mat", "C");
  CMatrix D;
  D.readMatlabFile("../matfiles" + ndlstrutil::dirSep() + "dotMatrixTest.mat", "D");
  CMatrix ind1;
  ind1.readMatlabFile("../matfiles" + ndlstrutil::dirSep() + "dotMatrixTest.mat", "i");
  int i = (int)ind1.getVal(0)-1;
  CMatrix ind2;
  ind2.readMatlabFile("../matfiles" + ndlstrutil::dirSep() + "dotMatrixTest.mat", "j");
  int j = (int)ind2.getVal(0)-1;
  CMatrix DOT1;
  DOT1.readMatlabFile("../matfiles" + ndlstrutil::dirSep() + "dotMatrixTest.mat", "DOT1");
  CMatrix DOT2;
  DOT2.readMatlabFile("../matfiles" + ndlstrutil::dirSep() + "dotMatrixTest.mat", "DOT2");
  CMatrix DOT3;
  DOT3.readMatlabFile("../matfiles" + ndlstrutil::dirSep() + "dotMatrixTest.mat", "DOT3");
  CMatrix DOT4;
  DOT4.readMatlabFile("../matfiles" + ndlstrutil::dirSep() + "dotMatrixTest.mat", "DOT4");
  if(abs(DOT1.getVal(0)-A.dotRowRow(j, B, j))<ndlutil::MATCHTOL)
  ...
  if(abs(DOT2.getVal(0)-A.dotRowCol(j, D, j))<ndlutil::MATCHTOL)
    cout << "dotRowCol matches." << endl;
  else
    {
      cout << "FAILURE: dotRowCol." << endl;
      fail++;
    }
  if(abs(DOT3.getVal(0)-C.dotColCol(j, D, j))<ndlutil::MATCHTOL)
    cout << "dotColCol matches." << endl;
  else
    {
      cout << "FAILURE: dotColCol." << endl;
      fail++;
    }
  if(abs(DOT4.getVal(0)-C.dotColRow(j, B, j))<ndlutil::MATCHTOL)
    cout << "dotColRow matches." << endl;
  else
    {
      cout << "FAILURE: dotColRow." << endl;
      fail++;
    }
  return fail;
}
int testNorm()
{
  int fail = 0;
  CMatrix A;
  A.readMatlabFile("../matfiles" + ndlstrutil::dirSep() + "normMatrixTest.mat", "A");
  CMatrix B; 
  B.readMatlabFile("../matfiles" + ndlstrutil::dirSep() + "normMatrixTest.mat", "B");
  CMatrix ind1;
  ind1.readMatlabFile("../matfiles" + ndlstrutil::dirSep() + "normMatrixTest.mat", "i");
  int i = (int)ind1.getVal(0)-1;
  CMatrix ind2;
  ind2.readMatlabFile("../matfiles" + ndlstrutil::dirSep() + "normMatrixTest.mat", "j");
  int j = (int)ind2.getVal(0)-1;
  CMatrix NORM1;
  NORM1.readMatlabFile("../matfiles" + ndlstrutil::dirSep() + "normMatrixTest.mat", "NORM1");
  CMatrix NORM2;
  NORM2.readMatlabFile("../matfiles" + ndlstrutil::dirSep() + "normMatrixTest.mat", "NORM2");
  if(abs(NORM1.getVal(0)-A.norm2Row(j))<ndlutil::MATCHTOL)
  ...
  if(abs(NORM2.getVal(0)-B.norm2Col(i))<ndlutil::MATCHTOL)
    cout << "norm2Col matches." << endl;
  else
    {
      cout << "FAILURE: norm2Col." << endl;
      fail++;
    }
...
int testInv()
{
  ...
  // Matrix inverse test
  CMatrix A;
  A.readMatlabFile("../matfiles" + ndlstrutil::dirSep() + "invMatrixTest.mat", "A");
  CMatrix Ainv;
  Ainv.readMatlabFile("../matfiles" + ndlstrutil::dirSep() + "invMatrixTest.mat", "Ainv");
  A.inv();
  if(Ainv.equals(A))
...
int testCholesky()
{
  ...
  // Lower Cholesky test.
  CMatrix C;
  C.readMatlabFile("../matfiles" + ndlstrutil::dirSep() + "choleskyMatrixTest.mat", "C");
  C.setSymmetric(true);
  CMatrix L;
  L.readMatlabFile("../matfiles" + ndlstrutil::dirSep() + "choleskyMatrixTest.mat", "L");
  C.chol("L");
  if(L.equals(C))
    {
  ...
  C.trans();
  CMatrix U;
  U.readMatlabFile("../matfiles" + ndlstrutil::dirSep() + "choleskyMatrixTest.mat", "U");
  if(U.equals(C))
