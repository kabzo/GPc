...
void CMatrix::gemvRowRow(unsigned int i,
                         const CMatrix &A,
                         const CMatrix &x,
                         unsigned int k,
                         double alpha,
...
void CMatrix::gemvRowCol(unsigned int i,
                         const CMatrix &A,
                         const CMatrix &x,
                         unsigned int j,
                         double alpha,
...
void CMatrix::gemvColCol(unsigned int j,
                         const CMatrix &A,
                         const CMatrix &x,
                         unsigned int k,
                         double alpha,
...
void CMatrix::gemvColRow(unsigned int j,
                         const CMatrix &A,
                         const CMatrix &x,
                         unsigned int i,
                         double alpha,
...
void CMatrix::symvRowRow(unsigned int i,
                         const CMatrix &A,
                         const CMatrix &x,
                         unsigned int k,
                         double alpha,
...
void CMatrix::symvRowCol(unsigned int i,
                         const CMatrix &A,
                         const CMatrix &x,
                         unsigned int j,
                         double alpha,
...
void CMatrix::symvColCol(unsigned int j,
                         const CMatrix &A,
                         const CMatrix &x,
                         unsigned int k,
                         double alpha,
...
void CMatrix::symvColColOff(unsigned int j,
                            int yr1,
                            const CMatrix &A,
                            const CMatrix &x,
                            unsigned int k,
...
void CMatrix::symvColRow(unsigned int j,
                         const CMatrix &A,
                         const CMatrix &x,
                         unsigned int i,
                         double alpha,
...
void CMatrix::gemm(const CMatrix &A,
                   const CMatrix &B,
                   double alpha,
                   double beta,
                   const char *transa,
...
void CMatrix::trmm(const CMatrix &A,
                   double alpha,
                   const char *side,
                   const char *type,
                   const char *trans,
...
void CMatrix::trsm(const CMatrix &A,
                   double alpha,
                   const char *side,
                   const char *type,
                   const char *trans,
...
void CMatrix::readParamsFromStream(istream &in) {
    ...
    for (unsigned int i = 0; i < getRows(); i++) {
        ...
        if (getCols() != tokens.size()) {
            throw ndlexceptions::StreamFormatError("matrix", "Incorrect number of columns in row " + ndlstrutil::itoa(i)
                                                             + " of matrix.");
        }
